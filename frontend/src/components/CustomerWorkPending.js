...
const CustomerWorkPending = ({setAuth}) => {
    ...
    function CancelButton(props) {
        ...
        if (props.date <= todaydate) {
            if (props.status == 'work_pending') {
                ...
                return (
                    ...
                    <td>
                        <button className="btn btn-danger mx-1" onClick={() => onCancel(props.bmaster_id, stat)} title="Cancel Booking" data-bs-toggle="modal" data-bs-target="#cancelbook">Cancel</button>
        ...
        return (
            ...
            <td><button className="btn btn-danger mx-1" onClick={() => onCancel(props.bmaster_id, stat)} title="Cancel Booking" data-bs-toggle="modal" data-bs-target="#cancelbook">Cancel</button></td>
        );
    }
                    ...
                    <div className="card border-secondary">
                        <div className="card-header">
                            <ul className="nav nav-pills card-header-pills">
                                ...
                                <li className="nav-item">
                                    <a className="nav-link text-dark button mx-2" onClick={() => setTab("payment pending")} href="#">Work Completed / Payment Pending</a>
                                </li>
                                <li className="nav-item">
